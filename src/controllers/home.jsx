...
import { AlertCircle, ChevronRight, Wind, Wrench, Snowflake, ArrowRight } from 'lucide-react'

// Importa el componente de promoción
import Promocion from '../controllers/promocion'
...
export default function MainPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50">
      ...
      {/* Llama al componente de promociones */}
      <Promocion />
