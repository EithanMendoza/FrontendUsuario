      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white shadow-2xl rounded-3xl overflow-hidden border border-blue-100">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4 flex items-center justify-between">
            ...
            <span className="text-blue-200 text-sm bg-blue-700 px-3 py-1 rounded-full">ID: {solicitudId}</span>
          </div>
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="relative py-10">
              ...
              <div 
                className="absolute left-0 top-1/2 h-2 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full transition-all duration-500 ease-in-out transform -translate-y-1/2"
              ...
              <div className="relative flex justify-between">
                {steps.map((step, index) => (
                  <div key={step.name} className="flex flex-col items-center">
                    ...
                    {index <= currentStep && (
                      <div className="mt-2 h-2 w-2 rounded-full bg-blue-600 animate-pulse"></div>
                    )}
                  </div>
                ))}
              </div>
            ...
            {serviceDetails && (
              <div className="grid gap-8 md:grid-cols-2">
                <ServiceCard title="Detalles del Servicio" icon="📋">
                ...
                <ServiceCard title="Especificaciones Técnicas" icon="🔧">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-6 shadow-inner">
              <h3 className="text-2xl font-bold text-blue-900 mb-6 pb-2 border-b border-blue-200 flex items-center">
                <span className="mr-2">📅</span> Historial de Progreso
              </h3>
              <div className="space-y-6">
                {progressData.length > 0 ? (
                  progressData.map((item, index) => (
                    <div key={index} className="flex items-start space-x-4 border-l-4 border-blue-600 pl-4 pb-4 hover:bg-blue-100 transition-all duration-300 rounded-lg">
...
function ServiceCard({ title, icon, children }) {
  return (
    <div className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-2xl shadow-md transition-all duration-300 hover:shadow-lg border border-blue-100">
      <h3 className="text-xl font-semibold text-blue-900 mb-4 pb-2 border-b border-blue-200 flex items-center">
